...
<td width="161"><input type="text" name="name" size="20" value="<?php echo $user->name; ?>" /></td>
...
<td><input type="text" name="email" size="20" value="<?php echo $user->email; ?>" /></td>
...
<td><input type="text" name="mobile" size="20" value="<?php echo $user->mobile; ?>" /></td>
...
<td><textarea name="address" rows="5" cols="20"><?php echo $user-> address; ?></textarea></td>
